...
namespace FuelCardSystemMVC.Library.CustomAuth
{
    ...
    public class CustomIdentity : IIdentity
    {
        ...
        public CustomIdentity(IIdentity identity)
        {
            ...
            var customMembershipUser = (Staff)objCustomMembershipProvider.GetUserDetails(identity.Name);
            if (customMembershipUser != null)
            {
                userId = customMembershipUser.Staff_id;
                userFirstName = customMembershipUser.Staff_Name;
                email = customMembershipUser.Staff_Email;
                loginId = customMembershipUser.Staff_Email;
                roleType = customMembershipUser.Staff_Role;
